...
const VacanciesPostsAtHome = () => {
  return (
    <div className="sliding-text-container" style={{background:'#111'}}>        
        ...
        <p className="p__opensans sliding-text">Join us at our newest branch at The Gables Mall in Eswatini! Explore available opportunities on our vacancies page.</p>
