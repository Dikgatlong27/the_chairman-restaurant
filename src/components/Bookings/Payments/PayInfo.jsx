...
const PayInfo = () => {
  return (
    <>
      ...
      <p className="app__payInfo-conditions">Booking Confirmation: A non-refundable deposit of R1000 is required for reservations with more than 10 people.<br/> Deposit Payment: The deposit will be deducted from the final bill.<br/> Final Payment: The remaining balance must be settled on the reservation day.<br/> Additional Charges: Any extra services or items will be added to the final bill.<br/> Payment Methods: Cash or direct deposits.<br/> Service Charge: A discretionary service charge may apply for larger groups.<br/> Agreement: By booking and paying the deposit, you agree to the terms and conditions.</p>
    </>
